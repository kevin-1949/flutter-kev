          ...
          children: [
            DrawerHeader(
              child: UserAccountsDrawerHeader(
                accountName: Text('kevin gutierrez'),
                accountEmail: Text('kdgutierrez745@soy.sena.edu.co'),
              ),
            ),
            ListTile(
              title: Text('inicio'),
        ...
        children: [
          CircleAvatar(
            ...
            backgroundImage: NetworkImage(
                'https://media-bog2-1.cdn.whatsapp.net/v/t61.24694-24/425252447_1152223299529621_5551469587740032677_n.jpg?ccb=11-4&oh=01_Q5AaIIIXFD9D0ytic7z-_KDMtu9kwN-xODx0dHD2hHhe2G6C&oe=663388CF&_nc_sid=e6ed6c&_nc_cat=110'),
          ),
          Text(''),
          Text(''),
          Text(''),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          ListTile(
            title: Text('kevin gutierrez'),
            subtitle: Text('kevin gutierrez'),
          ...
          ListTile(
            title: Text('contacto'),
            subtitle: Text('3148281168'),
            leading: Icon(Icons.phone),
            trailing: Icon(Icons.arrow_right_alt_sharp),
          ),
          ListTile(
            title: Text('coreo'),
            subtitle: Text('kdgutierrez745@soy.sena.edu.co'),
